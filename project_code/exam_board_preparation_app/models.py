...
class GradedWork(models.Model):
    ...
    course = models.ForeignKey(
        Course, on_delete=models.CASCADE, related_name="work_course")
    student = models.ForeignKey(
        Student, on_delete=models.CASCADE, related_name="work_student")
    weighting = models.IntegerField()
    gradeMark = models.IntegerField()
    moderation = models.DecimalField(
        default=1.0, decimal_places=2, max_digits=5)
...
class DegreeClassification(models.Model):
    ...
    lowerGPAStandard = models.FloatField()
