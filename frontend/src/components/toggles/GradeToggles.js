...
export default function GradeToggles({changeGradeState}) {
  ...
  return (
    ...
    >
      <ToggleButton size="small" value="percentage">Percentage</ToggleButton>
      <ToggleButton size="small" value="band">Band</ToggleButton>
      <ToggleButton size="small" value="point">Point</ToggleButton>
    </ToggleButtonGroup>
  );
}
